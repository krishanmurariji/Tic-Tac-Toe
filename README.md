...
A single-page, responsive, animated, and highly-designed Tic-Tac-Toe game built with HTML, CSS, and JavaScript. 🚀
...
- Dynamic game board with winning conditions
...
1. Clone the repository: `git clone https://github.com/krishanmurariji/Tic-Tac-Toe.git`
2. Open the `index.html` file in your preferred web browser
3. Play the game against the computer and track your scores!
